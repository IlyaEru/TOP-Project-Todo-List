...
export const toDosContent = (function () {
    ...
    let todos
    if (localTodos === null){
         todos = [{ text: "Example", date: "2022-01-27", id: "3214412d", completed: false, project: 'Home' }];
    }
    ...
    return { initialTodos, checkTodoProjectCount, changedProject, updateCompleted, updateDate, updateUnCompleted, showAddTodoEvent, deleteTodoEvent, updateTodoDesc, changeTodoEvent }
})()